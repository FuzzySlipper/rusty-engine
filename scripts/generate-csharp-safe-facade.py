...
`native_api.rs` is the sole ABI source. This helper recognizes ordinary direct
...
// Generated mechanically from csharp-product-runtime/src/native_api.rs through cbindgen. Do not edit.
using System;
