...
use gameplay_continuous_mechanics::{
    ...
    ContinuousDecisionOutcome, ContinuousEffectApplyRequest, ContinuousEffectDefinition,
    ContinuousEffectDefinitionId, ContinuousEffectRemoveRequest, ContinuousEffectService,
    ContinuousIntrinsicSourceBinding, ContinuousIntrinsicSourcesComponent,
    ContinuousMechanicsCatalog, ContinuousMechanicsCatalogDefinition,
    ContinuousMechanicsComponentKind, ContinuousOperationId, ContinuousSourceDefinition,
    ContinuousSourceDefinitionId, ContinuousSourceIdentity, ContinuousStackingPolicy,
    ContinuousStatBaseMutationRequest, ContinuousStatContribution,
...
pub(crate) struct ContinuousMechanicsBridgeState {
    ...
    associations: BTreeMap<EntityId, u64>,
