...
pub use exact::{
    ...
    ExactCompileError, ExactEvaluationError, ExactEvaluationReceipt, ExactEvaluator, ExactExpr,
    ExactExprLimits, ExactExprRequirements, ExactInputBundle, ExactInputBundleError,
    ExactInputIdentity, ExactInputReference, ExactPredicateEvaluationReceipt, FixedPowerExpr,
    StandardExactFactReference, EXACT_EVALUATOR_SEMANTICS_VERSION,
};
pub use extension::{
...
pub use resolution::{
    ...
    STANDARD_DAMAGE_CAPABILITY, STANDARD_EFFECT_CAPABILITY, STANDARD_EQUIPMENT_CAPABILITY,
    STANDARD_INVENTORY_CAPABILITY, STANDARD_TRACK_CAPABILITY,
};
