...
pub use model::{
    ...
    MAX_DIRECT_INTENT_AXIS_MAGNITUDE, MAX_DIRECT_INTENT_PRODUCT_PAYLOAD_ARRAY_ENTRIES,
    MAX_DIRECT_INTENT_PRODUCT_PAYLOAD_BYTES, MAX_DIRECT_INTENT_PRODUCT_PAYLOAD_DEPTH,
    MAX_DIRECT_INTENT_PRODUCT_PAYLOAD_JSON_BYTES, MAX_DIRECT_INTENT_PRODUCT_PAYLOAD_NODES,
    MAX_DIRECT_INTENT_PRODUCT_PAYLOAD_OBJECT_ENTRIES,
