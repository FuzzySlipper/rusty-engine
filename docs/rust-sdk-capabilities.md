...
| `product-assembly` | `rusty_engine::product_assembly` |
| `product-dev-host` | `rusty_engine::product_dev_host` |
| `product-kernel` | `rusty_engine::product_kernel` |
| `product-materializer` | `rusty_engine::product_materializer` |
...
| `runtime-composition` | `rusty_engine::runtime_composition` |
...
| `runtime-ui` | `rusty_engine::runtime_ui` |
