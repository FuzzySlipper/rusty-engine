...
Protocol 12 retains only bounded component identity and owner metadata in its core project readout.
...
| --- | --- | --- |
| Core protocol version | `STUDIO_ADAPTER_PROTOCOL_VERSION = 12` | `studio-adapter-client` and each project adapter |
