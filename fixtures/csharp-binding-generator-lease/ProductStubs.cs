...
public enum InputAxis : uint { None }
public enum KeyboardControl : uint { None }
public enum PointerButton : uint { None }
public enum ControllerButton : uint { None }
public enum ControllerAxis : uint { None }
public enum InputEventKind : uint { None }
public enum InputDevice : uint { None }
public enum InputChannel : uint { None }
