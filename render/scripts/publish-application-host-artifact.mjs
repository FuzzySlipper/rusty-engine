...
for (const file of ['index.d.ts', 'application-host.d.ts', 'application-content.d.ts']) {
...
writeFileSync(
  ...
  `${JSON.stringify({
    ...
    files: ['application-content.d.ts', 'application-host.d.ts', 'developer-command-client.d.ts', 'developer-command-client.js', 'developer-command-shell.d.ts', 'generated-developer-command-contract.d.ts', 'generated-developer-command-contract.js', 'generated-standard-host-wire.d.ts', 'generated-standard-host-wire.js', 'index.d.ts', 'index.js'],
  }, null, 2)}\n`,
);
