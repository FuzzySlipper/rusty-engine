...
test('one generic Studio address opens a declared consumer and rejects roots transactionally', async ({ page }) => {
  ...
  await expect(identity).toHaveAttribute('data-active-project-root', voxelRoot);
