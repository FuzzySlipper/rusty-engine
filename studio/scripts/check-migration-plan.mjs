...
const expectedOwners = new Set([
  ...
  'developer-command', 'developer-command-standard', 'entity-state', 'environment-authoring', 'gameplay-continuous-mechanics', 'gameplay-mechanics', 'gameplay-resolution',
  'gameplay-rules', 'gameplay-standard', 'product-kernel', 'product-model', 'render-model',
